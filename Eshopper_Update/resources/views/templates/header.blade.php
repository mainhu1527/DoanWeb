...
<body>
	...
	<div class="header">
		...
		<div class="header_top">
			...
			<div class="search_box">
	     		<form action='search'>
	     			<input type="text" value="Bạn muốn tìm gì?" name='usr' onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';}">
	...
	<nav id="primary_nav_wrap">
		<ul>
			...
			<li><a href="search?usr=tim kiem ">Tìm kiếm nâng cao</a></li>
		</ul>
		<div class="clear"></div>
	</nav>	
</body>